...
def find_central_circle(img, back_middle_point, front_middle_point, main_line, debug=False):
    """
...
while cap.isOpened():
    ...
    img = key_lines.draw(frame)
    # img = key_points.draw(frame)

    # Salve ou processe o frame
